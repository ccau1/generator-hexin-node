...
const PluginInjector = require('./PluginInjectorConfig');
...
module.exports = class AppStart extends AppStartBase {
  ...
  setHandlers(appConfig) {
    ...
    this.handle(new PluginInjector(appConfig));
    this.handle(new Seed(appConfig));
    ...
    // this.handle(new Mailer(appConfig));
